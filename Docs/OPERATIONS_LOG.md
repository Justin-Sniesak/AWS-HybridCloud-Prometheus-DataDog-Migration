...
- **2025-10-19** — Bring up WireGuard on EC2 instance, validate that it can ping the peer hosted on the on-prem hypervisor, and confirm that the handshake completed successfully.  
